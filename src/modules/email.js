...
body {font-family: 'Chivo', sans-serif;}
  ...
  <![endif]-->
    ...
    <tr>
      <td role="module-content">
        <p>You've been invited to edit a document!</p>
      </td>
    </tr>
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 20px 30px 30px;" bgcolor="#fff" data-distribution="1">
    <tbody>
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:50% !important; width:50%; height:auto !important;" width="265" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/64b66770c62e07be/a632fe96-6713-42fc-921c-5873202da76a/764x266.png">
        </td>
      </tr>
    </tbody>
  </table></td>
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 20px 40px 30px;" bgcolor="#fff" data-distribution="1">
    <tbody>
      <tr role="module-content">
        <td height="100%" valign="top"><table width="530" style="width:530px; border-spacing:0; border-collapse:collapse; margin:0px 10px 0px 10px;" cellpadding="0" cellspacing="0" align="left" border="0" bgcolor="" class="column column-0">
      <tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 10px 18px 10px; line-height:32px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #5785ce; font-size: 48px">You have been invited!</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Someone sent you an invite to edit a document with you.</div>
<div style="font-family: inherit; text-align: center">Accept the invitation by clicking the button below, and start collaborating!</div><div></div></div></td>
      </tr>
    </tbody>
        ...
        <tr>
          <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px;">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                <tr>
                <td align="center" bgcolor="#5785ce" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a href="${host}/accept?docid=${data.docid}&user=${data.user}" style="background-color:#5785ce; border:1px solid #333333; border-color:#333333; border-radius:0px; border-width:1px; color:#ffffff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 30px 12px 30px; text-align:center; text-decoration:none; border-style:solid;" target="_blank">Accept Invite</a></td>
                </tr>
              </tbody>
            </table>
          </td>
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="NaN" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/64b66770c62e07be/116149cf-aaac-4c6c-9744-578505b93163/943x796.png">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:40px 30px 40px 30px; line-height:22px; text-align:inherit; background-color:#5785ce;" height="100%" valign="top" bgcolor="#5785ce" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff">Don't have an AuroDocs account? Register using the link below. If you already have an account, you can use the Login link to login after accepting the invite, and start editing the document.</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="#5785CE" data-distribution="1,1">
    <tbody>
      <tr role="module-content">
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="1b7e3d29-0bf1-47eb-99b6-c789ddfd7d62" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><a href="http://www.student.bth.se/~auro17/editor/#register"><span style="color: #ffffff; font-size: 18px"><u><strong>Register</strong></u></span></a></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="63583be3-5274-476c-beaf-ebf8410d7786" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><a href="http://www.student.bth.se/~auro17/editor/#login"><span style="color: #ffffff; font-size: 18px"><u><strong>Login</strong></u></span></a></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
